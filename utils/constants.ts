export const fallBackTemplate = `1. **Major Cities**: Explore the urban centers with their unique architecture, museums, historical sites, and vibrant culture.
...
export const checker_prompt = `I am thinking of calling the info tool with the info below. \
...
export const tavilyFallBack = `1. **Popular Cities**: Major urban centers with unique architecture, museums, historical sites, and vibrant local culture.
