...
exports.createItinerarySummary = createItinerarySummary;
// v1 code
const llmOutput_1 = __importDefault(require("./llmOutput"));
function createItinerarySummary(plan) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve) => {
            const parsedPlan = llmOutput_1.default.parse(plan);
            const summary = `${parsedPlan.numberOfTravelers} traveler(s) planning a trip to ${parsedPlan.destination} 
